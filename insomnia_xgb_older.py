...
# Saves: insomnia_xgb_older_adult.pkl -> {'xgb': model, 'scaler': scaler}
...
# ---------------------------------------------------------------
# 2. FILTER TO OLDER ADULT COHORT (55-79)
#    Matches insomnia_rf_older_adult.py filter: age >= 55
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# 4. FEATURE SELECTION
#    Same 20 features as insomnia_rf_older_adult.py
...
# ---------------------------------------------------------------
print("\n" + "=" * 60)
print("TRAINING XGBOOST — INSOMNIA (OLDER ADULTS 55-79)")
print("=" * 60)
...
plt.tight_layout()
plt.savefig("plots/xgb_insomnia_feature_importance_older.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("\n  Plot saved: plots/xgb_insomnia_feature_importance_older.png")
...
plt.tight_layout()
plt.savefig("plots/xgb_insomnia_confusion_matrix_older.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("  Plot saved: plots/xgb_insomnia_confusion_matrix_older.png")
...
ax.set_ylim([0, 1.02])
plt.tight_layout()
plt.savefig("plots/xgb_insomnia_roc_curve_older.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("  Plot saved: plots/xgb_insomnia_roc_curve_older.png")
...
with open("insomnia_xgb_older_adult.pkl", "wb") as f:
    pickle.dump(bundle, f)
print("\n  Model saved: insomnia_xgb_older_adult.pkl")
