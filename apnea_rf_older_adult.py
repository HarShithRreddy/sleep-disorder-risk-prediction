...
def train_apnea_older_adult():
    ...
    # --------------------------------------------------
    # Filter to Older Adult cohort (56–79)
    # --------------------------------------------------
    ...
    print("\n" + "=" * 60)
    print("TRAINING RANDOM FOREST — APNEA (OLDER ADULTS 56–79)")
    print("=" * 60)
    ...
    plt.tight_layout()
    plt.savefig('plots/rf_apnea_feature_importance_older.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("\n  Plot saved: plots/rf_apnea_feature_importance_older.png")
    ...
    plt.tight_layout()
    plt.savefig('plots/rf_apnea_confusion_matrix_older.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("  Plot saved: plots/rf_apnea_confusion_matrix_older.png")
    ...
    ax.set_ylim([0, 1.02])
    plt.tight_layout()
    plt.savefig('plots/rf_apnea_roc_curve_older.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("  Plot saved: plots/rf_apnea_roc_curve_older.png")
    ...
    with open("apnea_rf_older_adult.pkl", "wb") as f:
        pickle.dump({'rf': rf, 'scaler': scaler}, f)
    print("Model saved: apnea_rf_older_adult.pkl")


if __name__ == "__main__":
    train_apnea_older_adult()