...
# Saves: insomnia_xgb_young_adult.pkl -> {'xgb': model, 'scaler': scaler}
...
# ---------------------------------------------------------------
# 2. FILTER TO YOUNG ADULT COHORT (18-35)
# ---------------------------------------------------------------
...
#    Consistent with teammate's RF scripts:
...
# ---------------------------------------------------------------
# 4. FEATURE SELECTION
#    Same 20 features as insomnia_rf_young_adult.py
...
# ---------------------------------------------------------------
print("\n" + "=" * 60)
print("TRAINING XGBOOST — INSOMNIA (YOUNG ADULTS 18-35)")
print("=" * 60)
...
plt.tight_layout()
plt.savefig("plots/xgb_insomnia_feature_importance_young.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("\n  Plot saved: plots/xgb_insomnia_feature_importance_young.png")
...
plt.tight_layout()
plt.savefig("plots/xgb_insomnia_confusion_matrix_young.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("  Plot saved: plots/xgb_insomnia_confusion_matrix_young.png")
...
ax.set_ylim([0, 1.02])
plt.tight_layout()
plt.savefig("plots/xgb_insomnia_roc_curve_young.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("  Plot saved: plots/xgb_insomnia_roc_curve_young.png")
...
with open("insomnia_xgb_young_adult.pkl", "wb") as f:
    pickle.dump(bundle, f)
print("\n  Model saved: insomnia_xgb_young_adult.pkl")
