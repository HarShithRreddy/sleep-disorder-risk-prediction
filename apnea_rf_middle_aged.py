...
def train_apnea_middle_aged():
    ...
    # --------------------------------------------------
    # Filter to Middle-Aged cohort (36–55)
    # --------------------------------------------------
    ...
    print("\n" + "=" * 60)
    print("TRAINING RANDOM FOREST — APNEA (MIDDLE-AGED 36–55)")
    print("=" * 60)
    ...
    plt.tight_layout()
    plt.savefig('plots/rf_apnea_feature_importance_midage.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("\n  Plot saved: plots/rf_apnea_feature_importance_midage.png")
    ...
    plt.tight_layout()
    plt.savefig('plots/rf_apnea_confusion_matrix_midage.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("  Plot saved: plots/rf_apnea_confusion_matrix_midage.png")
    ...
    ax.set_ylim([0, 1.02])
    plt.tight_layout()
    plt.savefig('plots/rf_apnea_roc_curve_midage.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("  Plot saved: plots/rf_apnea_roc_curve_midage.png")
    ...
    with open("apnea_rf_middle_aged.pkl", "wb") as f:
        pickle.dump({'rf': rf, 'scaler': scaler}, f)
    print("Model saved: apnea_rf_middle_aged.pkl")


if __name__ == "__main__":
    train_apnea_middle_aged()