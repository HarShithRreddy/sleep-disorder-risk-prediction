# apnea_xgb_young_adult.py
# XGBoost — Sleep Apnea Risk Prediction
# Cohort: Young Adults (Age 18-35)
# Mirrors apnea_rf_young_adult.py's data/target logic exactly,
# and insomnia_xgb_young_adult.py's XGBoost config exactly.
# Saves: apnea_xgb_young_adult.pkl -> {'xgb': model, 'scaler': scaler}
...
#    Matches apnea_rf_young_adult.py filter: age <= 35
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# 5. FEATURE SELECTION
#    Same 22 features as apnea_rf_young_adult.py
...
# ---------------------------------------------------------------
print("\n" + "=" * 60)
print("TRAINING XGBOOST — APNEA (YOUNG ADULTS 18-35)")
print("=" * 60)
...
plt.tight_layout()
plt.savefig("plots/xgb_apnea_feature_importance_young.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("\n  Plot saved: plots/xgb_apnea_feature_importance_young.png")
...
plt.tight_layout()
plt.savefig("plots/xgb_apnea_confusion_matrix_young.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("  Plot saved: plots/xgb_apnea_confusion_matrix_young.png")
...
ax.set_ylim([0, 1.02])
plt.tight_layout()
plt.savefig("plots/xgb_apnea_roc_curve_young.png",
            dpi=150, bbox_inches="tight")
plt.close()
print("  Plot saved: plots/xgb_apnea_roc_curve_young.png")
...
with open("apnea_xgb_young_adult.pkl", "wb") as f:
    pickle.dump(bundle, f)
print("\n  Model saved: apnea_xgb_young_adult.pkl")
